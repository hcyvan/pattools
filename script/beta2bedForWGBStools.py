...
# 创建命令行参数解析器
parser = argparse.ArgumentParser(description='Convert the *.beta generated by wgbs_tools to *.bed')
parser.add_argument('-i', dest='input_path', help='Input binary path. Generated from ls: ls /your_file/GSM*.beta > beta_path')
parser.add_argument('-f', dest='path_file', help='Input binary path file ')
parser.add_argument('-o', dest='output_dir', help='Output dir')
parser.add_argument('-c', dest='cpg_coordinate', required=True, help='CpG coordinate file generated by wgbtools. For example: /wgbs_tools/references/hg38/CpG.bed.gz')
